...
async def discover_all() -> dict[str, Any]:
        ...
        try:
            for source in CATEGORY_SOURCES:
                ...
                try:
                    ...
                    logger.warning(
                        "Browser discovery failed for %s: %s",
                        source["name"],
                        exc,
                    )
                    result = {
    ...
    return {
        ...
        "categories": results,
        "notice": (
            "Ürünler gerçek Chromium tarayıcısında oluşturulan kamuya açık "
            "Trendyol kategori kartlarından keşfedildi."
        ),
    }
...
def health():
    return {
        ...
        "discovery_engine": "browser_render_v5",
...
<div class="app">
<header class="top">
  <div><div class="brand">Ürün<span>Radar</span></div><div class="sub">Trendyol Otomatik Radar v5</div></div>
