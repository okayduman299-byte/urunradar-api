...
async def discover_all() -> dict[str, Any]:
    ...
    if DISCOVERY_LOCK.locked():
        return {
            "ok": False,
            "busy": True,
            "engine": "browser_render_v7_low_memory",
            "added": 0,
            "failed": 0,
            "candidates": 0,
            "categories": [],
...
def health():
    return {
        ...
        "discovery_engine": "browser_render_v7_low_memory",
...
<div class="app">
<header class="top">
  <div><div class="brand">Ürün<span>Radar</span></div><div class="sub">Trendyol Otomatik Radar v7</div></div>
