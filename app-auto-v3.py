...
async def fetch_category_candidates(
    ...
    """
    Read a public Trendyol category page and extract product URLs.

    This avoids /sr search-result URLs and uses normal category pages such as:
    /fritoz-x-c1055 and /robot-supurge-x-c109453.
    """
    headers = {
        "User-Agent": USER_AGENT,
        "Accept-Language": "tr-TR,tr;q=0.9,en;q=0.7",
...
def health():
    return {
        ...
        "discovery_engine": "category_pages_v3",
...
<div class="app">
<header class="top">
  <div><div class="brand">Ürün<span>Radar</span></div><div class="sub">Trendyol Otomatik Radar v3</div></div>
    ...
    toast(
      r.added > 0
        ...
        : firstError
          ...
          : `0 ürün eklendi. ${r.candidates || 0} aday bulundu.`
    );
